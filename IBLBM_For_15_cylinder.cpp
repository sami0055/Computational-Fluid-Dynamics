...
const int num_cylinders = 15; // Number of cylinders
...
const double particle_center_x[num_cylinders] = {10, 20, 30, 40, 50,10,20, 30, 40, 50,10, 20, 30, 40, 50}; // Center position x-component for each cylinder
const double particle_center_y[num_cylinders] = {20, 20, 20, 20, 20,10,10,10,10,10,30,30,30,30,30}; // Center position y-component for each cylinder
...
particle_struct(2), particle_struct(3),particle_struct(4),particle_struct(5),particle_struct(6),
particle_struct(7),particle_struct(8),particle_struct(9),particle_struct(10),particle_struct(11),
particle_struct(12),particle_struct(13),particle_struct(14)
